...
public class TaskRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        UserID.setText("TRecord ID");

        Password.setText("UserID");

        Name.setText("Time Recorded");

        Time.setText("Description");

        Current_Balance.setText("Fee");


        add.setText("TRecordID");

        update.setText("UserID");

        delete.setText("Time Created");

        clear.setText("Description");
        ...
        jLabel6.setText("Task Record Pane");
		...
		String filePath = "C:\\Users\\howard\\Desktop\\oop\\project\\taskrecord.txt";  // filepath for Task Record file
        ...
        update.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
				...
				try{
					BufferedReader br = new BufferedReader(new FileReader(file));
					PrintWriter pw = new PrintWriter(new FileWriter("ctext.txt"));
					String temp;
					int j=0;
					Object[] row = new Object[5];
					row[0] = jTextField1.getText();
					...
					new File("ctext.txt").renameTo(new File("text.txt"));
		...
		delete.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				model.removeRow(i);
				try { 
					BufferedWriter bw = new BufferedWriter(new FileWriter("ctext.txt",false));
					PrintWriter pw = new PrintWriter(bw);
